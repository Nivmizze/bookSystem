$(
		function(){
			//按钮切换图片
			$("#add").css("background","url(/bookSystem/images/hong_2_btn.jpg)");
			$("#add").mouseover(function(){
				$("#add").css("background","url(/bookSystem/images/hong_1_btn.jpg)");
			});
...
function check(){
	if(checkBname()&&checkImage_w()&&checkImage_b()&&checkPrice()
			&&checkDiscount()&&checkAuthor()&&checkPress()
